...
LABEL_DESCRIPTION="ROS2 Cuisine dependencies to build and test"
LABEL_VCS__URL="https://github.com/ros2cuisine/builder-release"
LABEL_DOCKER_CMD="docker pull ros2cuisine/builder"
